...
\input{../uniforme/dist_uniforme}
\input{../gi0/dist_g_i_zero}
\input{../binomial/dist_binomial}
\input{../gamma/dist_gamma}
\input{../exponencial/dist_exp}
\input{../t-studant/dist_t}
...
\input{../gi0/result_gi0}
\input{../binomial/result_binomial}
\input{../gamma/result_gamma}
